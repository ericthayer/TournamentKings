module.exports = {
    ...
    methods: {
         ...
         */
        getRevenue() {
            axios.get('/spark/kiosk/performance-indicators/revenue').then(response => {
         ...
         */
        getPlans() {
            axios.get('/spark/kiosk/performance-indicators/plans').then(response => {
         ...
         */
        getTrialUsers() {
            axios.get('/spark/kiosk/performance-indicators/trialing').then(response => {
        ...
        getPerformanceIndicators() {
            axios.get('/spark/kiosk/performance-indicators').then(response => {
        ...
        drawMonthlyRecurringRevenueChart() {
            return this.drawCurrencyChart(
                ...
                30,
                indicator => indicator.monthly_recurring_revenue
            );
        },
        ...
        drawYearlyRecurringRevenueChart() {
            return this.drawCurrencyChart(
                'yearlyRecurringRevenueChart',
                30,
                indicator => indicator.yearly_recurring_revenue
            );
        },
        ...
        drawDailyVolumeChart() {
            return this.drawCurrencyChart('dailyVolumeChart', 14, indicator => indicator.daily_volume);
        },
         ...
         */
        drawNewUsersChart() {
            return this.drawChart('newUsersChart', 14, indicator => indicator.new_users);
        },
        ...
        drawCurrencyChart(id, days, dataGatherer) {
            return this.drawChart(id, days, dataGatherer, value => Vue.filter('currency')(value.value));
        },
