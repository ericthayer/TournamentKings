...
module.exports = {
    ...
    methods: {
         ...
         */
        getAnnouncements() {
            axios.get('/spark/kiosk/announcements').then(response => {
         ...
         */
        create() {
            Spark.post('/spark/kiosk/announcements', this.createForm).then(() => {
         ...
         */
        update() {
            Spark.put('/spark/kiosk/announcements/' + this.updatingAnnouncement.id, this.updateForm).then(() => {
                this.getAnnouncements();
         ...
         */
        deleteAnnouncement() {
            Spark.delete('/spark/kiosk/announcements/' + this.deletingAnnouncement.id, this.deleteForm).then(() => {
                this.getAnnouncements();
