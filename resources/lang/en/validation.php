...
return [
    ...
    */
    ...
    'custom' => [
        'nonce' => [
            'required' => 'We apologize. Your payment could not be processed.',
        ],
        'otp'       => 'This token is invalid',
        'entry_fee' => [
            'required_if' => 'An amount is required for flat fee',
        ],
        'target_pot' => [
            'required_if' => 'An amount is required for target pot',
        ],
    ],
