...
<html lang="en">
    ...
    <body>
        ...
        <header class="site-header" role="banner">
            <!-- Main Menu -->
            <nav id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/tournaments">Tournaments</a></li>
                    <li class="cta">
                        <a href="/tournaments/create" class="btn-outline-light">Create Your Own</a>
                    </li>
                </ul>
            </nav>
            <nav class="navbar">
              <div class="container-fluid">
                  <div class="navbar-header">
                      ...
                      <div class="navbar-controls logged-in">
            ...
            <section class="hero">
                ...
                <div class="text">
                    <div class="text-wrap">
                        <h1 class="title font-bullpen-3D">Successfully Joined Tournament!</h1>
                        <p class="subtitle">{{__('landing.thankyou')}}</p>
                        {{-- <div class="actions">
                          <a href="/tournaments/create">Create Your Own</a>
                        </div> --}}
                    </div>

                    <!-- Latest Tournaments -->
                    <div id="carousel-latest-tournaments" class="carousel card--carousel" data-ride="carousel" style="display: none;">
                        <small class="label">Upcoming Tournaments</small>
                ...
                <div class="media">
                    <img class="hero-img" src="media/images/content/img-gamer-excited.jpg" alt="">
                </div>
        ...
        <footer class="site-footer no-clip" role="contentinfo">
            <div class="container">
