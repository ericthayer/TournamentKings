...
<spark-navbar
    ...
    <nav class="navbar navbar-spark">
        <div class="container" v-if="user">
            ...
            <div id="navbarSupportedContent" class="app-nav">
                <ul class="app-menu">
                    @includeIf('spark::nav.user-left')
                </ul>
                <ul class="user-menu">
                    <a @click="showNotifications" class="notification-pill mr-4">
                      ...
                      <li class="nav-item dropdown">
                        <a href="#" class="d-flex text-center nav-link dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            ...
                            @if (session('spark:impersonator'))
                                <p class="dropdown-header"><strong>{{__('Impersonation')}}</strong></p>
                            ...
                            <!-- Settings -->
                            <p class="dropdown-header"><strong>{{__('Settings')}}</strong></p>
