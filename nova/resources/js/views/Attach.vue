    ...
    methods: {
        ...
        getField() {
            ...
            Nova.request()
                ...
                .then(({ data }) => {
                    this.field = data;
                    this.field.searchable ? this.determineIfSoftDeletes() : this.getAvailableResources();
                    this.loading = false;
                });
        },
        ...
        getPivotFields() {
            ...
            Nova.request()
                .get('/nova-api/' + this.resourceName + '/creation-pivot-fields/' + this.relatedResourceName, {
                    params: {
                        editing: true,
                        editMode: 'attach',
                    },
        ...
        getAvailableResources(search = '') {
            Nova.request()
                .get(`/nova-api/${this.resourceName}/${this.resourceId}/attachable/${this.relatedResourceName}`, {
                    params: {
                        search,
        ...
        selectInitialResource() {
            this.selectedResource = _.find(this.availableResources, r => r.value == this.selectedResourceId);
        },
    ...
    computed: {
        ...
        attachmentEndpoint() {
            return this.polymorphic
                ...
                : '/nova-api/' + this.resourceName + '/' + this.resourceId + '/attach/' + this.relatedResourceName;
        },
