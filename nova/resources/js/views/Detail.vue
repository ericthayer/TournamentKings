<template>
    <loading-view :loading="initialLoading">
        ...
        <!-- Resource Detail -->
        <div v-for="panel in availablePanels" :dusk="resourceName + '-detail-component'" class="mb-8" :key="panel.id">
            <component
                :is="panel.component"
                :resource-name="resourceName"
                :resource-id="resourceId"
...
<script>
import { InteractsWithResourceInformation, Errors, Deletable, Minimum, HasCards } from 'laravel-nova';
...
export default {
    ...
    methods: {
        ...
        getResource() {
            ...
            return Minimum(Nova.request().get('/nova-api/' + this.resourceName + '/' + this.resourceId))
