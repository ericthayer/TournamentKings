<template>
    <div class="checkbox select-none rounded">
        <svg class="block" v-if="checked" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
        ...
        <svg class="block" v-else width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            <g id="Page-1" fill="none" fill-rule="evenodd">
                <g id="checkbox-off">
                    <g id="b-link" fill="#FFF" fill-rule="nonzero">
                        <rect id="b" width="20" height="20" rx="4" />
                    </g>
                    <rect id="Rectangle-path" width="19" height="19" x=".5" y=".5" stroke="#CCD4DB" rx="4" />
                </g>
            </g>
        </svg>
    </div>
