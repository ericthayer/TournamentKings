                            ...
                            <a :href="resources" class="no-underline dim flex p-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-90 leading-normal">
                                        Nova's resource manager allows you to quickly view and manage your Eloquent
                                        model records directly from Nova's intuitive interface.
                                    </p>
                                </div>
                            </a>
                        </td>
                            ...
                            <a :href="actions" class="no-underline dim flex p-6">
                                <div class="flex justify-center w-11 flex-no-shrink mr-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
                                        <g id="Page-1" fill="none" fill-rule="evenodd">
                                            <g id="icon-actions" fill="var(--primary)" fill-rule="nonzero">
                                                <path
                                                    id="Shape"
                                ...
                                <div>
                                    ...
                                    <p class="text-90 leading-normal">
                                        Actions perform tasks on a single record or an entire batch of records. Have an
                                        action that takes a while? No problem. Nova can queue them using Laravel's
                            ...
                            <a :href="filters" class="no-underline dim flex p-6">
                                <div class="flex justify-center w-11 flex-no-shrink mr-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38">
                                        <g id="Page-1" fill="none" fill-rule="evenodd">
                                            <g id="icon-filters" fill="var(--primary)" fill-rule="nonzero">
                                                <path
                                                    id="Shape"
                                ...
                                <div>
                                    ...
                                    <p class="text-90 leading-normal">
                                        Write custom filters for your resource indexes to offer your users quick glances
                                        at different segments of your data.
                                    </p>
                                </div>
                            </a>
                        </td>
                            ...
                            <a :href="lenses" class="no-underline dim flex p-6">
                                <div class="flex justify-center w-11 flex-no-shrink mr-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
                                        <g id="Page-1" fill="none" fill-rule="evenodd">
                                            <g id="icon-lenses" fill="var(--primary)" fill-rule="nonzero">
                                                <path
                                                    id="Shape"
                                ...
                                <div>
                                    ...
                                    <p class="text-90 leading-normal">
                                        Need to customize a resource list a little more than a filter can provider? No
                                        problem. Add lenses to your resource to take full control over the entire
                                        Eloquent query.
                                    </p>
                                </div>
                            </a>
                            ...
                            <a :href="metrics" class="no-underline dim flex p-6">
                                <div class="flex justify-center w-11 flex-no-shrink mr-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="37" height="36" viewBox="0 0 37 36">
                                        <g id="Page-1" fill="none" fill-rule="evenodd">
                                            <g id="icon-metrics" fill="var(--primary)" fill-rule="nonzero">
                                                <path
                                                    id="Shape"
                                ...
                                <div>
                                    ...
                                    <p class="text-90 leading-normal">
                                        Nova makes it painless to quickly display custom metrics for your application.
                                        To put the cherry on top, we’ve included query helpers to make it all easy as
                                        pie.
                                    </p>
                                </div>
                            </a>
                        ...
                        <td class="align-top w-1/2 border-b border-50">
                            <a :href="cards" class="no-underline dim flex p-6">
                                <div class="flex justify-center w-11 flex-no-shrink mr-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
                                        <g id="Page-1" fill="none" fill-rule="evenodd">
                                            <g id="icon-cards" fill="var(--primary)" fill-rule="nonzero">
                                                <path
                                                    id="Shape"
                                ...
                                <div>
                                    ...
                                    <p class="text-90 leading-normal">
                                        Nova offers CLI generators for scaffolding your own custom cards. We’ll give you
                                        a Vue component and infinite possibilities.
                                    </p>
                                </div>
                            </a>
                        </td>
