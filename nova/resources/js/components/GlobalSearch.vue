...
export default {
    ...
    methods: {
            ...
            this.$nextTick(() => {
                if (selection) {
                    if (
                        ...
                        container.scrollTop =
                            selection[0].offsetTop + selection[0].clientHeight - container.clientHeight;
                    }
        ...
        goToCurrentlySelectedResource() {
            const resource = _.find(this.indexedResults, res => res.index == this.highlightedResultIndex);
        ...
        formattedResults() {
            return _.map(this.formattedGroups, group => {
                return {
                    ...
                    items: _.filter(this.indexedResults, item => item.resourceName == group.resourceName),
                };
            });
        },
    },
