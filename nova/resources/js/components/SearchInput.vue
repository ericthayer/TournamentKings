<template>
    <div :data-testid="dataTestid" :dusk="dataTestid" :class="{ 'opacity-75': disabled }" v-on-clickaway="close">
        <div class="relative">
            <div
                ref="input"
                @click="open"
                ...
                :tabindex="show ? -1 : 0"
            >
                <div v-if="shouldShowDropdownArrow && !disabled" class="search-input-trigger absolute pin select-box" />
