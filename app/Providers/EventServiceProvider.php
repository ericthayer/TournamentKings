...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        'App\Events\WonMatch' => [
            'App\Listeners\AwardPlayers',
        ],

        'App\Events\Tournament\BuyIn' => [
            'App\Listeners\UpdatePrizes',
        ],

        'App\Events\UserWithdrawal' => [
            'App\Listeners\PayUser',
        ],

        'App\Events\TournamentDeleted' => [
            'App\Listeners\RefundUser',
        ],
    ];
